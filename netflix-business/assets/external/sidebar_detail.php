...
if( !empty($currentLocation['phone']) ){
    echo
    '<h5><i class="fa fa-phone"></i><a href="tel:'. $currentLocation['phone'] .'">'. $currentLocation['phone'] .'</a></h5>';
}
...
if( !empty($currentLocation['email']) ){
    echo
        '<h5><i class="fa fa-envelope"></i><a href="mailto:'. $currentLocation['email'] .'">'. $currentLocation['email'] .'</a></h5>';
}
...
if( !empty($currentLocation['website']) ){
    echo
        '<h5><a href="'. $currentLocation['website'] .'" target="_blank"><i class="fa fa-globe"></i>'. $currentLocation['website'] .'</a></h5>';
}
